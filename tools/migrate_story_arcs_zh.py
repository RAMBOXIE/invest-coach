...
def make_beats(cfg: dict) -> list[dict]:
    ...
    return [
        ...
        {"id": "s3", "kind": "reveal", "eyebrow": record_label, "title": record_title, "quote": {"src": record_src, "line": record_loc, "text": record_quote, "orig": record_quote}, "lines": [record_line], "narration": "现在回头看你的选择。当时抓住决定局面的那条线，比猜中结局更重要。"},
